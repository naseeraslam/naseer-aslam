      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {portfolioData.metrics.map((metric, idx) => (
            <div
              key={metric.label}
              className="scroll-fade p-5 rounded-2xl bg-slate-900/80 border border-slate-800/90 hover:border-orange-500/40 backdrop-blur-xl shadow-lg hover:scale-105 transition-all text-center space-y-1 group"
